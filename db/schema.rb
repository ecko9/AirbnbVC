...
ActiveRecord::Schema.define(version: 2021_07_29_151404) do
  ...
  create_table "join_dogs_on_a_strolls", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "dog_id"
    t.integer "stroll_id"
    t.index ["dog_id"], name: "index_join_dogs_on_a_strolls_on_dog_id"
    t.index ["stroll_id"], name: "index_join_dogs_on_a_strolls_on_stroll_id"
  end
